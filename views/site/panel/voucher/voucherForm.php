...
$form = ActiveForm::begin(['layout' => 'horizontal', 'action' => $scenario == 'edit' ? Url::to(['site/voucheredit']) : Url::to(['site/']), 'enableAjaxValidation' => true, 'id' => 'table-form']);
...
//
        ...
        return false;
          ...
          $(function () {
            $('#voucher-assign_date').datetimepicker({
...
<div class="form-group">
   ...
   <div class="col-sm-6"><?php echo $model->serial ?></div>
</div>
